...
def train(train_loader, model, criterion, optimizer, scheduler, epoch):
    ...
    for index, (input, target) in enumerate(train_loader):
        ...
        jigsaw_stack = model.conv1(jigsaw_stack)
        jigsaw_stack = model.bn1(jigsaw_stack)
        jigsaw_stack = model.relu(jigsaw_stack)
        jigsaw_stack = model.majigsaw_stackpool(jigsaw_stack)
        jigsaw_stack = model.layer1(jigsaw_stack)
        jigsaw_stack = model.layer2(jigsaw_stack)
        jigsaw_stack = model.layer3(jigsaw_stack)
        jigsaw_stack = model.layer4(jigsaw_stack)
        jigsaw_stack = model.avgpool(jigsaw_stack)
        jigsaw_stack = jigsaw_stack.view(input.shape[0], -1)
        output = model.fc(jigsaw_stack)
